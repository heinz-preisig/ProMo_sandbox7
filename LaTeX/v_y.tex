...
\section*{Equation assignment sequence for variable $v_y$}
...
\hline
\endlastfoot
1 &2 &- &\begin{eq}t :: \text{port variable}\end{eq} & \\1 &16 &- &\begin{eq}r_y :: \text{port variable}\end{eq} & \\0 &37 &21 &\begin{eq}{v_y}_{N} := \ParDiff{{r_{y}}_{N}}{{t}_{}}\end{eq} & \\
\end{longtable}
