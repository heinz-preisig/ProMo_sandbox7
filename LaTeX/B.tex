...
\section*{Equation assignment sequence for variable $B$}
...
\hline
\endlastfoot
2 &3 &- &\begin{eq}{\#}_{} :: \text{port variable}\end{eq} & \\1 &20 &- &\begin{eq}{S}_{N} :: \text{port variable}\end{eq} & \\0 &27 &11 &\begin{eq}{B}_{N} := Set({S}_{N}, {\#}_{})\end{eq} & \\\end{longtable}
