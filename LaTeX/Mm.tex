...
\section*{Equation assignment sequence for variable $\lambda$}
...
\hline
\endlastfoot
1 &1 &- &\begin{eq}{\#}{_{}} :: \text{port variable}\end{eq} & \\
0 &29 &142 &\begin{eq}{\lambda}{_{S}} := \text{Instantiate}({\lambda}{_{S}}, {\#}{_{}})\end{eq} & \\
