...
\section*{Equation assignment sequence for variable $a$}
...
\hline
\endlastfoot
2 &1 &- &\begin{eq}{\#}{_{}} :: \text{port variable}\end{eq} & \\
1 &175 &171 &\begin{eq}{\xi}{_{N}} := \text{Instantiate}({\xi}{_{N}}, {\#}{_{}})\end{eq} & \\
0 &189 &192 &\begin{eq}{a}{_{N}} := {\xi}{_{N}}\end{eq} & \\
