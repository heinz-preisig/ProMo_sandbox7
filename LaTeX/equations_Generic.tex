...
\hyperlink{"v:141"}{ 113 }\hypertarget{"e:113"}{  } &
    \begin{eq}{{\ckeck{I}}}{_{N}} := {I}{_{N}}\end{eq} &
...
\hyperlink{"v:145"}{ 117 }\hypertarget{"e:117"}{  } &
    \begin{eq}{RComputed}{_{N}} := \left( {{\ckeck{I}}}{_{N}} \right)^{-1} \, . \, {{\check{U}^e}}{_{N}}\end{eq} &
    \begin{lay}measured resistance \end{lay} &
    \begin{lay}control\end{lay} \\
\hyperlink{"v:146"}{ 118 }\hypertarget{"e:118"}{  } &
    \begin{eq}{store}{_{}} := \text{MixedStack}\left( {{\ckeck{I}}}{_{N}},{{\check{U}^e}}{_{N}},{RComputed}{_{N}},{{\check{\xi}}}{_{}} \right)\end{eq} &
