...
\section*{Equation assignment sequence for variable $Av$}
...
\hline
\endlastfoot
0 &101 &- &\begin{eq}Av :: \text{port variable}\end{eq} & \\\end{longtable}
\newpage
\begin{figure}\includegraphics[width=\textwidth]{ /home/heinz/1_Gits/CAM-projects_v8/Ontology_Repository/HAP_Playground_03/ontology_graphs/Av.pdf}
\end{figure}
