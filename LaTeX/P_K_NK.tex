...
\section*{Equation assignment sequence for variable $P$}
...
\hline
\endlastfoot
0 &11 &- &\begin{eq}P_K_NK :: \text{port variable}\end{eq} & \\\end{longtable}
\newpage
\begin{figure}\includegraphics{ /home/heinz/1_Gits/CAM-projects_v8/Ontology_Repository/HAP_Playground_03/ontology_graphs/P_K_NK.pdf}
\end{figure}
