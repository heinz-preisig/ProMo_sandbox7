...
\section*{Equation assignment sequence for variable $r_{x}$}
...
\hline
\endlastfoot
0 &15 &- &\begin{eq}r_x :: \text{port variable}\end{eq} & \\\end{longtable}
\newpage
\begin{figure}\includegraphics[width=\textwidth, height=\textheight]{ /home/heinz/1_Gits/CAM-projects_v8/Ontology_Repository/HAP_Playground_03/ontology_graphs/r_x.pdf}
\end{figure}
