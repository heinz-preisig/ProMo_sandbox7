...
\section*{Equation assignment sequence for variable $T$}
...
\hline
\endlastfoot
2 &14 &- &\begin{eq}{S}{_{N}} :: \text{port variable}\end{eq} & \\
1 &13 &- &\begin{eq}{U}{_{N}} :: \text{port variable}\end{eq} & \\
0 &18 &7 &\begin{eq}{T}{_{N}} := \ParDiff{{U}{_{N}}}{{S}{_{N}}}\end{eq} & \\
